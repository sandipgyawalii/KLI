                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="application_name" class="form-control @error('application_name') is-invalid @enderror"
                                    value="{{ old('application_name') }}" placeholder="e.g. Mero Rate" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="application_slogan" class="form-control @error('application_slogan') is-invalid @enderror"
                                    value="{{ old('application_slogan') }}" placeholder="e.g. Compare & Save Smartly">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                                    value="{{ old('address') }}" placeholder="e.g. Kathmandu, Nepal" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                                    value="{{ old('phone') }}" placeholder="e.g. +977 9800000000">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email') }}" placeholder="e.g. info@example.com">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="{{ $social }}" class="form-control @error($social) is-invalid @enderror"
                                        value="{{ old($social) }}" placeholder="https://{{ $social }}.com/your-page">
